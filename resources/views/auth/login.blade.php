<x-authentication-layout>
    ...
    <form class="flex flex-col items-center" method="POST" action="{{ route('login') }}">
        ...
        <div class="mb-6 p-1 rounded bg-white relative w-full h-11 lg:h-[52px]">
            ...
            <img src="{{ asset('images/asset/image/img/email.svg') }}" class="absolute top-1/2 right-2 -translate-y-1/2">
        </div>
        ...
        <div class="mb-6 p-1 rounded bg-white relative w-full h-11 lg:h-[52px]">
            ...
            <img id="togglePassword" src="{{ asset('images/asset/image/img/close_eye.svg') }}" class="absolute top-1/2 right-2 -translate-y-1/2">
        </div>
