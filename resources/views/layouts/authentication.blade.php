...
<body>
    <div class="font-sans text-gray-900 antialiased">
        ...
        <div>
            <div class="bg-no-repeat bg-cover right-0" style="background-image: url('{{ asset('images/asset/image/img/background.svg') }}');">
                <div class="min-h-screen lg:mx-[114px] md:mx-14">
                    <div class="absolute hidden md:block top-1">
                        <img src="{{ asset('images/asset/image/img/smartfarm_logo 2.svg') }}">
                    </div>
    ...
    <script>
        document.getElementById('togglePassword').addEventListener('click', function() {
            ...
            if (passwordInput.type === 'password') {
                ...
                icon.src = "{{ asset('images/asset/image/img/open_eye.svg') }}";
            } else {
                passwordInput.type = 'password';
                icon.src = "{{ asset('images/asset/image/img/close_eye.svg') }}";
            }
        });
    </script>
</body>
